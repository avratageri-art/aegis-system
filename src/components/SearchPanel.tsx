  ...
  return (
    <div className="space-y-6">
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Button id="submit-investigation-button" type="submit" className="w-full h-12 font-bold uppercase tracking-widest" disabled={isLoading || (mode === 'epieos' ? !Object.values(targetDetails).some(Boolean) : !target.trim())}>
          {isLoading ? (
            <>
